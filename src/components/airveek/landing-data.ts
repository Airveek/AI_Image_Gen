...
export const featureArtworks = {
  ...
  aiLogoMaker: { src: "/images/artistly/features/ai-logo-maker-v5.png", width: 1024, height: 1536, alt: "Airveek gaming emblem with gold dragon armor and electric-blue glow" },
  ...
  printOnDemand: { src: "/images/artistly/audiences/print-on-demand-merchandise-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded coral T-shirt, violet hoodie, canvas tote, and ceramic mug arranged as a colorful print-on-demand collection" },
  ecommerceAudience: { src: "/images/artistly/audiences/ecommerce-product-mockup-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded cobalt blue bottle, box, and dropper arranged on a pale stone pedestal for ecommerce" },
  marketingAudience: { src: "/images/artistly/audiences/marketing-campaign-visual-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded magenta and orange abstract campaign poster installation in a dark gallery" },
  digitalProductsAudience: { src: "/images/artistly/audiences/digital-products-workspace-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded digital products displayed across printable planners, a workbook, and a tablet" },
  freelanceWorkAudience: { src: "/images/artistly/audiences/freelance-workspace-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek client project shown in a freelance designer workspace with teal boards and branded notebook" },
  personalCreativityAudience: { src: "/images/artistly/audiences/personal-creativity-studio-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded character artwork, sketchbook, and clay figure in a warm personal art studio" },
