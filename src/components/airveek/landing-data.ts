...
export const featureArtworks = {
  ...
  printOnDemand: { src: "/images/artistly/audiences/print-on-demand-merchandise-v2.png", width: 1254, height: 1254, alt: "Coral t-shirt, violet hoodie, canvas tote, and ceramic mug arranged as a colorful print-on-demand collection" },
  ecommerceAudience: { src: "/images/artistly/audiences/ecommerce-product-mockup-v2.png", width: 1254, height: 1254, alt: "Cobalt blue skincare bottle, box, and dropper arranged on a pale stone pedestal for ecommerce" },
  marketingAudience: { src: "/images/artistly/audiences/marketing-campaign-visual-v2.png", width: 1254, height: 1254, alt: "Magenta and orange abstract campaign poster installation in a dark gallery for marketing graphics" },
  digitalProductsAudience: { src: "/images/artistly/audiences/digital-products-workspace-v2.png", width: 1254, height: 1254, alt: "Lavender workspace with printable planners, coloring pages, workbook, and tablet layouts" },
  freelanceWorkAudience: { src: "/images/artistly/audiences/freelance-workspace-v2.png", width: 1254, height: 1254, alt: "Freelance designer workspace with teal client boards, notebook, swatches, and desk lamp" },
  personalCreativityAudience: { src: "/images/artistly/audiences/personal-creativity-studio-v2.png", width: 1254, height: 1254, alt: "Warm personal art studio with character sketchbook, clay figure, brushes, and watercolor palette" },
