...
export const galleryArtworks: Artwork[] = [
  { src: "/images/airveek/features/AI-Image/nickype-ai-generated-8783349_1920.jpg", width: 1086, height: 1920, alt: "AI-generated vertical fantasy artwork" },
  { src: "/images/airveek/features/AI-Image/StockCake-Gothic_Cathedral_Warrior-4972014-standard.png", width: 1408, height: 1408, alt: "AI-generated gothic cathedral warrior artwork" },
  { src: "/images/airveek/features/AI-Image/01-0429668-65bba28868e06.png", width: 1024, height: 1360, alt: "AI-generated portrait artwork" },
  { src: "/images/airveek/features/AI-Image/12-0315400-65a0b7e5f1c4c.png", width: 1024, height: 1360, alt: "AI-generated illustrated character artwork" },
  { src: "/images/airveek/features/AI-Image/07-0656752-6639ead607bd2.png", width: 1024, height: 1360, alt: "AI-generated fantasy character artwork" },
  { src: "/images/airveek/features/AI-Image/01-0427665-65baefc40c9e8.png", width: 1024, height: 1360, alt: "AI-generated astronaut artwork" },
  { src: "/images/airveek/features/AI-Image/18-0353466-65a9506e2dbb8.png", width: 1024, height: 1360, alt: "AI-generated portrait with glowing light artwork" },
  { src: "/images/airveek/features/AI-Image/07-0560076-65e984ea0be17.png", width: 1024, height: 1360, alt: "AI-generated tiger warrior artwork" },
  { src: "/images/airveek/features/AI-Image/13-0470100-65cb24b6b28e6.png", width: 1024, height: 1360, alt: "AI-generated fantasy illustration" },
  { src: "/images/airveek/features/AI-Image/22-1096280-6a393c2dcc74f.png", width: 896, height: 1200, alt: "AI-generated illustrated scene" },
  { src: "/images/airveek/features/AI-Image/17-0344968-65a7a11b019db.png", width: 1024, height: 1024, alt: "AI-generated square portrait artwork" },
  { src: "/images/airveek/features/AI-Image/StockCake-Pop_Art_Portrait-4952110-standard.png", width: 1024, height: 1024, alt: "AI-generated pop art portrait" },
  { src: "/images/airveek/features/AI-Image/StockCake-Cyberpunk_Canine_Glow-2204566-standard.png", width: 768, height: 1344, alt: "AI-generated cyberpunk canine artwork" },
  { src: "/images/airveek/features/AI-Image/StockCake-Ethereal_Anime_Magic-4713678-standard.png", width: 768, height: 1344, alt: "AI-generated ethereal anime magic artwork" },
  { src: "/images/airveek/features/AI-Image/StockCake-Industrial_Watercolor_Portrait-4968131-standard.png", width: 720, height: 1280, alt: "AI-generated industrial watercolor portrait" },
];

export const featureArtworks = {
  unlimitedAiImageCreator: { src: "/images/airveek/features/unlimited-ai-image-creator-v3.png", width: 1536, height: 1024, alt: "Luminous AI creativity studio with floating portrait, landscape, astronaut, perfume, and abstract artwork panels" },
  perfectTextInAiImages: { src: "/images/airveek/features/perfect-text-in-ai-images-v4.png", width: 1536, height: 1024, alt: "Futuristic sneaker launch poster with perfectly readable RUN THE FUTURE and NIGHT SHIFT / 01 typography" },
  aiProductMockupCreator: { src: "/images/airveek/features/ai-product-mockup-creator-v2.png", width: 960, height: 1696, alt: "Airveek branded glowing water bottle product mockup suspended between crystalline rocks" },
  aiProductPhotographer: { src: "/images/airveek/features/ai-product-photographer-v3.png", width: 1254, height: 1254, alt: "Airveek branded chocolate spread jar photographed in a miniature snowy mountain scene with tiny skiers" },
  instantSceneBackgroundEditor: { src: "/images/airveek/features/instant-scene-background-editor-v3.png", width: 1536, height: 1024, alt: "Surreal tropical scene with a scooter rider, tigers, palm trees, and a motion-blurred road" },
  smartImageExpander: { src: "/images/airveek/features/smart-image-expander-v2.png", width: 1536, height: 1024, alt: "Expanded panoramic alpine valley with a warmly lit cabin, winding river, and snow-capped mountains" },
  aiLogoMaker: { src: "/images/airveek/features/ai-logo-maker-v5.png", width: 1024, height: 1536, alt: "Airveek gaming emblem with gold dragon armor and electric-blue glow" },
  canvasStyleImageEditor: { src: "/images/airveek/features/canvas-style-image-editor-v3.jpg", width: 1200, height: 1600, alt: "Painterly portrait surrounded by colorful expressive brush strokes" },
  coloringBookGenerator: { src: "/images/airveek/features/coloring-book-generator.png", width: 1536, height: 1024, alt: "Premium woodland coloring-book spread with colored pencils" },
  consistentCharacter: { src: "/images/airveek/features/consistent-character-v3.png", width: 1448, height: 1086, alt: "The same girl with identical facial features across rainy, lunar, fantasy, and brand-studio scenes" },
  aiImageUpscaler: { src: "/images/airveek/features/ai-image-upscaler-v2.png", width: 1536, height: 1024, alt: "Kingfisher photo transitioning from visible pixels to sharp feather detail" },
  aiHumanInpainting: { src: "/images/airveek/features/ai-human-inpainting-v2.png", width: 1448, height: 1086, alt: "A clean split portrait transformation changing hair, clothing, an accessory, and the background" },
  aiStyleReplicator: { src: "/images/airveek/features/ai-style-replicator-v2.png", width: 1448, height: 1086, alt: "A portrait, coastal landscape, and floral artwork sharing one vibrant painterly style" },
  personalizedStorybookMaker: { src: "/images/airveek/features/personalized-storybook-maker-v2.png", width: 1448, height: 1086, alt: "A child reading a personalized magical storybook featuring his portrait, a castle, and a friendly fox" },
  talkingStorybookCreator: { src: "/images/airveek/features/talking-storybook-creator-v2.png", width: 1448, height: 1086, alt: "A child reading an illustrated book aloud as glowing narration waves travel toward a listening puppy" },
  multilingualStorybookMaker: { src: "/images/airveek/features/multilingual-storybook-maker-v2.png", width: 1448, height: 1086, alt: "Three diverse children exploring connected global story worlds in one multilingual book" },
  virtualModelCreator: { src: "/images/airveek/features/virtual-model-creator-v2.png", width: 1536, height: 1024, alt: "Three models wearing the same cobalt overshirt in a studio lookbook" },
  aiFashionDesigner: { src: "/images/airveek/features/ai-fashion-designer-v2.png", width: 1536, height: 1024, alt: "Couture model in a sapphire, tangerine, blush, and gold fashion design" },
  aiThumbnailMaker: { src: "/images/airveek/features/ai-thumbnail-maker-v2.png", width: 1448, height: 1086, alt: "A bold split-screen creator thumbnail contrasting zero views with one million views" },
  printOnDemand: { src: "/images/airveek/audiences/print-on-demand-merchandise-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded coral T-shirt, violet hoodie, canvas tote, and ceramic mug arranged as a colorful print-on-demand collection" },
  ecommerceAudience: { src: "/images/airveek/audiences/ecommerce-product-mockup-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded cobalt blue bottle, box, and dropper arranged on a pale stone pedestal for ecommerce" },
  marketingAudience: { src: "/images/airveek/audiences/marketing-campaign-visual-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded magenta and orange abstract campaign poster installation in a dark gallery" },
  digitalProductsAudience: { src: "/images/airveek/audiences/digital-products-workspace-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded digital products displayed across printable planners, a workbook, and a tablet" },
  freelanceWorkAudience: { src: "/images/airveek/audiences/freelance-workspace-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek client project shown in a freelance designer workspace with teal boards and branded notebook" },
  personalCreativityAudience: { src: "/images/airveek/audiences/personal-creativity-studio-airveek-v3.png", width: 1254, height: 1254, alt: "Airveek branded character artwork, sketchbook, and clay figure in a warm personal art studio" },
  aiCharacterCreator: { src: "/images/airveek/features/ai-character-creator-v2.png", width: 1448, height: 1086, alt: "A complete fantasy character sheet with consistent hero views, expressions, palette, sidekick, and villain" },
  bulkClipartDesigner: { src: "/images/airveek/features/bulk-clipart-designer-v3.png", width: 1448, height: 1086, alt: "One fox idea branching into a consistent sixteen-piece woodland clipart collection and product previews" },
...
export const faqs = [
  {
    ...
    answer: "Airveek brings image generation, editing, mockups, background tools, upscaling, and commercial-ready workflows into one simple creative suite with clear plans.",
  },
  {
  ...
  },
  {
    ...
    answer: "Choose the $49 Commercial plan or $147 Premium plan. The checkout page shows whether the current offer is one-time or recurring, and payment is handled securely by the active provider.",
  },
  {
