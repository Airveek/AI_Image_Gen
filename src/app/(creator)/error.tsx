...
export default function CreatorError({ reset }: { reset: () => void }) {
  return (
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="max-w-md rounded-2xl border border-danger/25 bg-danger-soft p-8 text-center">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">Try the page again. If this continues, ask an administrator to check creator storage and provider settings.</p>
